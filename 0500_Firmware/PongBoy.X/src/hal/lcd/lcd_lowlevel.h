...
//------------------------------------------------------------------------------
#define LCD_nRD           LATB5
#define LCD_nWR           LATB4
#define LCD_DnC           LATC5
//#define LCD_nRES          LATE4
#define LCD_nCS           LATC4

#define DIR_LCD_nRD       TRISB5
#define DIR_LCD_nWR       TRISB4
#define DIR_LCD_DnC       TRISC5
//#define DIR_LCD_nRES      TRISE4
#define DIR_LCD_nCS       TRISC4
...
/* OUTPUT		:                                                                 */
/******************************************************************************/
/* COMMENTS : Turns on LCD and all I/O pins ...                              */
/*            Do not forget to power on the LCD !!!                          */
/******************************************************************************/
