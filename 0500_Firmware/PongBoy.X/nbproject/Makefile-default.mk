...
SOURCEFILES_QUOTED_IF_SPACED=src/app/pong_ctrl.c src/app/menu_ctrl.c src/board/lcd/arialNarrow_12ptBitmaps.c src/board/lcd/lcd_highlevel.c src/board/tsc/tsc.c src/display/display.c src/game_objects/paddle.c src/game_objects/ball.c src/hal/lcd/lcd_lowlevel.c src/pongboy/pongboy.c src/xf/xf.c src/main.c src/configuration_bits.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/app/pong_ctrl.p1 ${OBJECTDIR}/src/app/menu_ctrl.p1 ${OBJECTDIR}/src/board/lcd/arialNarrow_12ptBitmaps.p1 ${OBJECTDIR}/src/board/lcd/lcd_highlevel.p1 ${OBJECTDIR}/src/board/tsc/tsc.p1 ${OBJECTDIR}/src/display/display.p1 ${OBJECTDIR}/src/game_objects/paddle.p1 ${OBJECTDIR}/src/game_objects/ball.p1 ${OBJECTDIR}/src/hal/lcd/lcd_lowlevel.p1 ${OBJECTDIR}/src/pongboy/pongboy.p1 ${OBJECTDIR}/src/xf/xf.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/configuration_bits.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/app/pong_ctrl.p1.d ${OBJECTDIR}/src/app/menu_ctrl.p1.d ${OBJECTDIR}/src/board/lcd/arialNarrow_12ptBitmaps.p1.d ${OBJECTDIR}/src/board/lcd/lcd_highlevel.p1.d ${OBJECTDIR}/src/board/tsc/tsc.p1.d ${OBJECTDIR}/src/display/display.p1.d ${OBJECTDIR}/src/game_objects/paddle.p1.d ${OBJECTDIR}/src/game_objects/ball.p1.d ${OBJECTDIR}/src/hal/lcd/lcd_lowlevel.p1.d ${OBJECTDIR}/src/pongboy/pongboy.p1.d ${OBJECTDIR}/src/xf/xf.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/configuration_bits.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/app/pong_ctrl.p1 ${OBJECTDIR}/src/app/menu_ctrl.p1 ${OBJECTDIR}/src/board/lcd/arialNarrow_12ptBitmaps.p1 ${OBJECTDIR}/src/board/lcd/lcd_highlevel.p1 ${OBJECTDIR}/src/board/tsc/tsc.p1 ${OBJECTDIR}/src/display/display.p1 ${OBJECTDIR}/src/game_objects/paddle.p1 ${OBJECTDIR}/src/game_objects/ball.p1 ${OBJECTDIR}/src/hal/lcd/lcd_lowlevel.p1 ${OBJECTDIR}/src/pongboy/pongboy.p1 ${OBJECTDIR}/src/xf/xf.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/configuration_bits.p1

# Source Files
SOURCEFILES=src/app/pong_ctrl.c src/app/menu_ctrl.c src/board/lcd/arialNarrow_12ptBitmaps.c src/board/lcd/lcd_highlevel.c src/board/tsc/tsc.c src/display/display.c src/game_objects/paddle.c src/game_objects/ball.c src/hal/lcd/lcd_lowlevel.c src/pongboy/pongboy.c src/xf/xf.c src/main.c src/configuration_bits.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/PongBoy.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PongBoy.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -memi=wordwrite -Os -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PongBoy.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
